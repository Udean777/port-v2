  ...
  return (
    <main className='min-h-screen bg-stone-300 dark:bg-stone-600'> 
      ...
      <div className='py-20 dark:text-white font-sans animate__animated animate__fadeInDown overflow-hidden'>
        <div>
          <h1 className='border-b-2 border-stone-400 text-3xl font-sans font-bold flex justify-center w-40 m-auto'>About me</h1>
        </div>
        <div className='text-center m-auto py-5 md:w-98 lg:w-100 xl:w-100 leading-7 text-stone-800 dark:text-stone-200'>
          <p>Im a Junior<span className='text-stone-500 dark:text-stone-300 font-bold'> FrontEnd Developer</span>, i love designing a website and makes it responsive, so the users can use my application in mobile & desktop.
          ...
          <p className='py-5'>Despite programming, i also have hobbies. My hobbies is listening to music, watching films, anime & korean drama, a little bit of singing, and programming.
            ...
            You can see my other skills in <Link href='/skills' className='font-bold hover:text-stone-400 transition ease-in'>skills section</Link>.
          </p>
        </div>
      </div>
    </main>
