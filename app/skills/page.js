      ...
      content: (
        ...
        <div className="justify-center grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
          <div className="w-40 my-5 overflow-hidden shadow-sm rounded-3xl
           dark:text-white hover:text-orange-600 dark:hover:text-orange-600 backdrop-blur-lg bg-zinc-50/10 dark:bg-zinc-700/30
        ...
        <div className="w-40 my-5 overflow-hidden shadow-sm rounded-3xl
           dark:text-white backdrop-blur-lg bg-zinc-50/10 dark:bg-zinc-700/30 dark:hover:text-blue-600 
        ...
        <div className="w-40 my-5 overflow-hidden shadow-sm rounded-3xl
           dark:text-white dark:hover:text-yellow-400 backdrop-blur-lg bg-zinc-50/10 dark:bg-zinc-700/30
    ...
    },
    {
      ...
      content: (
        ...
        <div className="justify-center grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
          <div className="w-40 my-5 overflow-hidden shadow-sm rounded-3xl
           dark:text-white dark:hover:text-purple-600 backdrop-blur-lg bg-zinc-50/10 dark:bg-zinc-700/30
        ...
        <div className="w-40 my-5 overflow-hidden shadow-sm rounded-3xl
           dark:text-white dark:hover:text-blue-600 backdrop-blur-lg bg-zinc-50/10 dark:bg-zinc-700/30
            dark:hover:bg-transparent hover:bg-transparent hover:text-blue-600 border-2
             border-zinc-500 hover:border-blue-600 transition ease-in">
        ...
        <div className="w-40 my-5 overflow-hidden shadow-sm rounded-3xl
           dark:text-white dark:hover:text-gray-500 backdrop-blur-lg bg-zinc-50/10 dark:bg-zinc-700/30
        ...
        <div className="w-40 my-5 overflow-hidden shadow-sm rounded-3xl
           dark:text-white dark:hover:text-blue-500 backdrop-blur-lg bg-zinc-50/10 dark:bg-zinc-700/30
